                    ...
                    <>
                        ...
                        <View style={styles.section}>
                            ...
                            <View style={styles.groupedCard}>
                                ...
                                <TouchableOpacity
                                    style={styles.innerDetailRow}
                                    onPress={() => openPicker('Education', ['Bachelors', 'Masters', 'PhD', 'High School', 'In College'], 'basics', 'education')}
                                >
                                    <Text style={styles.detailLabel}>Education</Text>
                                    <Text style={styles.detailValue}>{profile?.basics?.education || 'Add'}</Text>
                                    <Ionicons name="chevron-forward" size={18} color="#444" />
                                </TouchableOpacity>
                                <TouchableOpacity
                                    style={styles.innerDetailRow}
                        ...
                        <View style={styles.section}>
                            <View style={styles.sectionHeaderRow}>
                                ...
                                <Text style={styles.boostLabel}>+3%</Text>
                            </View>
                            <TextInput
