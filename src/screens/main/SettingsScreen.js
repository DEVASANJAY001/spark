    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.groupedCard}>
                    {renderSettingRow("Phone Number", profile?.phoneNumber || "917904116719", () => { })}
                </View>
                ...
                <View style={styles.groupedCard}>
                    {[
                        ...
                        { icon: 'baby-outline', label: 'Family Plans' },
                ...
                <View style={styles.groupedCard}>
                    {renderSettingRow("Help & Support", "", () => navigation.navigate('StaticContent', { type: 'help' }))}
                    {renderSettingRow("Report a problem", "", () => navigation.navigate('StaticContent', { type: 'report' }))}
                </View>
