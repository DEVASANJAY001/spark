...
const PhotoUploadScreen = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={styles.container}>
                ...
                <View style={styles.grid}>
                    {images.map((image, index) => (
                        <TouchableOpacity
                            ...
                            onPress={() => !image && !uploading && pickImage(index)}
                            disabled={uploading}
                        >
                            {image ? (
                                <>
            ...
            <TouchableOpacity
                style={[styles.nextButton, (uploading || imageCount < 2) && styles.nextButtonDisabled]}
                disabled={uploading || imageCount < 2}
                onPress={() => navigation.navigate('BioAndPrompts')}
            >
